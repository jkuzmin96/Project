...
<div class="row">
	...
	<div class="col-lg-9">
		...
		<div class="panel panel-default">
			...
			<div class="page-header">
				<h3>Waves<small>  Posted on May 24th</small></h3>
			</div>

			<img class="featuredImg" src="img/Waves.jpg" width="100%">
	...
	<div class="list-group">
		...
		<a href="read1.php" class="list-group-item active">
		...
		<a href="read3.php" class="list-group-item">
